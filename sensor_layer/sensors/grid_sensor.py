...
class GridSensor(BaseSensor):
    ...
    def get_reading(self):
        ...
        # Figure out what time period we're in and pick a realistic demand range. These ranges are rough but they reflect typical Irish household demand patterns:
        if 0 <= hour < 6:
