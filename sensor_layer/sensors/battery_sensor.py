...
class BatterySensor(BaseSensor):
    def __init__(self, home_id, dispatch_rate=5):
        ...
        # How much the charge changes per reading cycle (every dispatch_rate seconds).
        # These are small values because we're cycling every 5 seconds in simulation time
        # but they represent what would happen over a longer period in reality.
        ...
        # Safety limits — real Powerwalls don't go below ~5% or above ~95-100%
        # to protect battery health. I'm using 5-98 as my limits.
        self.min_charge = 5.0
    ...
    def get_reading(self):
        ...
        # During daylight hours (6am-8pm) assume the solar panels are charging the battery.
        # At night the battery is discharging to cover household loads.
        if 6 <= hour < 20:
        ...
        # Add a small random fluctuation to make it look more realistic.
        # In a real BMS there's always some measurement noise.
